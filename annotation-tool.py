...
# annotation tool how to use
# using the mouse, place the cursor at the top left corner of the license plate, press c, a
# move mouse to top right corner, press a, move to bottom right, press a, move to bottom left, press a
# press space bar, enter license number, press space and then n
